...
class TaskSettings: ObservableObject {
    @AppStorage("sidebarToolbarContent") var sidebarToolbarContent: [ToolbarContentItem] = [ToolbarContentItem("添加任务", image: "plus")]
    @AppStorage("detailToolbarContent") var detailToolbarContent: [ToolbarContentItem] = [ToolbarContentItem("添加子任务", image: "plus"), ToolbarContentItem("删除任务", image: "trash")]
